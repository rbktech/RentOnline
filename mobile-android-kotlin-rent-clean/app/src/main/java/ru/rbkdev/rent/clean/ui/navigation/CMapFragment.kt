...
import ru.rbkdev.rent.clean.CListExchange
import ru.rbkdev.rent.clean.CSettings
import ru.rbkdev.rent.clean.ui.clean.CCleanListActivity
                ...
                mBottomSheetSelectHouse?.let { bottomSheet ->
                    ...
                    if (!bottomSheet.isShowing) {
                        ...
                        btnSelectHouse.setOnClickListener {
                            ...
                            val intent = Intent(requireContext(), CCleanListActivity::class.java)
