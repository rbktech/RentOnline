    ...
    private fun parseMessage(context: Context, array: ByteArray, dataExchange: CDataExchange) {
        ...
        while (jsonReader.hasNext()) {
            ...
            when (value) {
                ...
                context.getString(R.string.exchange_id_user) -> {
                    dataExchange.setIdUser(jsonReader.nextString())
                }
                    ...
                    if (type != JsonToken.NULL) {
                        when (type) {
                            ...
                            JsonToken.BEGIN_ARRAY -> {
                                ...
                                if (dataExchange.getCommand() == "get_clean_data") {
                                    ...
                                    while (jsonReader.hasNext()) {
                                        ...
                                        while (jsonReader.hasNext()) {
                                            ...
                                            when (jsonReader.nextName()) {
                                                ...
                                                "code_password" -> item.codePassword = jsonReader.nextString()
