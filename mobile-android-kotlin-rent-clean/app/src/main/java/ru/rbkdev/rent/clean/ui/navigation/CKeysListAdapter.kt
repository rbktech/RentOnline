...
import ru.rbkdev.rent.clean.ui.house.entry.CStatus
import ru.rbkdev.rent.clean.room.CDatabaseViewModel
import ru.rbkdev.rent.clean.room.database.keys.CKeysTable
import ru.rbkdev.rent.clean.ui.house.entry.CHouseEntryActivity
...
class CBarcodeListAdapter(viewModelDatabase: CDatabaseViewModel?) :
    ...
    val mViewModelDatabase = viewModelDatabase
    ...
    inner class CBarcodeListViewHolder(itemView: View, private val adapter: CBarcodeListAdapter) :
        ...
        private fun clickItem() {
            ...
            intent.putExtra(mContext.getString(R.string.intent_address), house.addressLock)
        ...
        private fun cancel() {
            ...
            if (adapter.itemCount != 0) {
                ...
                dataExchange.setCommand("cancel_cleaning")
