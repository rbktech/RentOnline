...
uint8_t mark0[MARK_SIZE + 1] = { MARK_CSEPARATE, 0 };
uint8_t mark1[MARK_SIZE + 1] = { MARK_CBEGIN, 0 };
uint8_t mark2[MARK_SIZE + 1] = { MARK_CSIZE_PACK, 0 };
uint8_t mark3[MARK_SIZE + 1] = { MARK_CID_MESSAGE, 0 };
uint8_t mark4[MARK_SIZE + 1] = { MARK_CCOUNT_POSITION, 0 };
uint8_t mark5[MARK_SIZE + 1] = { MARK_CNUMBERS_POSITION, 0 };
uint8_t mark6[MARK_SIZE + 1] = { MARK_CSIZE_MESSAGE, 0 };
uint8_t mark7[MARK_SIZE + 1] = { MARK_CSRC, 0 };
uint8_t mark8[MARK_SIZE + 1] = { MARK_CEND, 0 };
...
{
	const int sizeOfDeparture = SIZE_TRAFFIC;
